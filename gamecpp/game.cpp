...
simulate_game(Input* input, float dt) {
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0x00BFFF);
	draw_arena_borders(arena_half_size_x, arena_half_size_y, 0xB22222);
	...
	if (current_gamemode == GM_GAMEPLAY) {
		...
		if (hot_button == 0) {
			draw_text("SINGLE PLAYER", -80, 5, 1, 0xff0000);
			draw_text("MULTIPLAYER", 15, 5, 1, 0xaaaaaa);
		}
		else {
			draw_text("SINGLE PLAYER", -80, 5, 1, 0xaaaaaa);
			draw_text("MULTIPLAYER", 15, 5, 1, 0xff0000);
		}
